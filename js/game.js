...
previousRecord == null ? bestResultCount.innerHTML = "Least tries: -" 
: bestResultCount.innerHTML = `Least tries: ${localStorage.getItem(`l${level}_bestCount`)}`;
...
switch (parseInt(level)) {
    case 1:
        ...
        document.querySelector(".lvls").style.backgroundImage = 'url("../assets/images/l1.webp")';

        // Changing audio
        music = new Audio("../assets/sounds/homeSweetHome.mp3");
        console.log("Now playing: from Soul Knight by Chilly Room - Home Sweet Home");
        ...
        maxTries = 5;
        triesIndicator.innerHTML = "You have 5 tries.";
    ...
    case 2:
        ...
        // Changing background image
        document.querySelector(".lvls").style.backgroundImage = 'url("../assets/images/l2.webp")';

        // Changing audio
        music = new Audio("../assets/sounds/bigBigWorld.mp3");
        console.log("Now playing: from Soul Knight by Chilly Room - Big Big World");
    ...
    case 3:
        ...
        // Changing background image
        document.querySelector(".lvls").style.backgroundImage = 'url("../assets/images/l3.webp")';

        // Changing audio
        music = new Audio("../assets/sounds/tillTheEndOfDawn.mp3");
        console.log("Now playing: from Soul Knight by Chilly Room - Till The End Of Dawn");
        ...
        // Changing tries indicator
        maxTries = 10;
        triesIndicator.innerHTML = "You have 10 tries.";
    ...
    case 4:
        ...
        // Changing background image
        document.querySelector(".lvls").style.backgroundImage = 'url("../assets/images/l4.png")';

        // Changing audio
        music = new Audio("../assets/sounds/bewareOfFalling.mp3");
        console.log("Now playing: from Soul Knight by Chilly Room - Beware Of Falling");
    ...
    case 5:
        ...
        // Changing background image
        document.querySelector(".lvls").style.backgroundImage = 'url("../assets/images/l5.png")';
        ...
        // Changing tries indicator
        maxTries = 20;
        triesIndicator.innerHTML = "You have 20 tries.";
...
const player = new Samurai({
    x: canvas.width/2-100, y: canvas.height/2-50, canvasWidth: canvas.width, canvasHeight: canvas.height, scale: 6
});
...
form.addEventListener("submit", (e) => {
    ...
    if (currentTries <= maxTries) {
        ...
        if (answer < number) {
            ...
            if (currentTries > maxTries) {
                transcript.innerHTML += "You've reached the max number of tries. Game over <br>";
                // Switch to player death spritesheet
                player.state = 1;
                setTimeout(() => { gameOver(number) }, 1000);
            }
        ...
        // User answer is correct
            ...
            console.log(`Correct answer, congrats. I hope you didn't cheat by opening inspect.`);
...
function win() {
    ...
    title.innerHTML = "You win! Congratulations!";
}
